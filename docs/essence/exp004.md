...
Cooldown Reduction was set past the final breakpoint (maximum reduction). See [Experimentarium #001 - Triple Shot Cooldown Reduction](https://islaiter.github.io/faq/essence/exp001/){ data-preview } for more information.
...
These key presses can then be compared to how quickly attacks are done by autohunt - as seen in [Experimentarium #001](https://islaiter.github.io/faq/essence/exp001/){ data-preview } .
