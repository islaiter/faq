...
> ⚠️ **Warning:** List is subject to changes as the development and CBT goes on
...
- From Gracia Final: During Territory Wars, flags cannot be taken outside the battle zone or placed in water. If a flag is dropped, it returns to the base.
- From Gracia Epilogue: Core and Orfen are now level 82, with adjusted drops.
- From H5: Ancient Adena exchange through the Black Marketeer is now done via a weekly quest, preventing abuses of the system.
- From H5: Added a new level 82+ Catacomb and Necropolis, allowing players to farm Ancient Adena without level penalty.

Currently in consideration:

- Considering reducing the xp penalty on PvP death, to invite more PvP and have it be a bit more forgiving